      ...
      <ScrollArea className="flex-1">
        <div className="p-4 space-y-4">
          ...
          <div className="grid grid-cols-4 gap-1">
            {[25, 50, 75, 100].map((pct) => (
              <button
                ...
                type="button"
                onClick={() =>
                  side === "buy" ? setPercentBuy(pct) : setPercentSell(pct)
                }
                ...
                >
                  ...
                  <div className="flex rounded overflow-hidden border border-border text-[10px] font-mono">
                    ...
                    <button
                      ...
                      style={
                        slMode === "trailing"
                          ? { backgroundColor: "oklch(0.18 0.07 55 / 0.6)" }
                          : undefined
                      }
                    >
                      Trailing
                    ...
                    <div className="space-y-1.5">
                      <div className="flex gap-1.5">
                        <Input
                          ...
                          style={{ borderColor: "oklch(0.40 0.14 55 / 0.6)" }}
                        />
                        {/* % / pts toggle */}
                        <div
                          className="flex rounded overflow-hidden border text-[10px] font-mono shrink-0"
                          style={{ borderColor: "oklch(0.40 0.14 55 / 0.5)" }}
                        >
                          <button
                            type="button"
                            ...
                            style={
                              trailType === "percent"
                                ...
                                : { borderColor: "oklch(0.40 0.14 55 / 0.3)" }
                            }
                          >
                            %
                          </button>
                      ...
                      {effectiveTrailSL > 0 && (
                        ...
                        >
                          <span className="opacity-70">Effective SL:</span>{" "}
                          <span className="font-semibold">
          ...
          >
            <div className="flex items-center justify-between">
              ...
              >
                <span
                  className={`text-xs font-mono font-semibold uppercase tracking-wide ${
                    tpEnabled ? "text-emerald-400" : "text-muted-foreground"
                  }`}
                >
                  Take Profit
                </span>
          ...
          <div className="rounded-md bg-muted/30 border border-border p-3 space-y-1.5 text-xs font-mono">
            ...
            {slEnabled &&
              (slMode === "trailing" ? effectiveTrailSL > 0 : slVal > 0) && (
                <div
                ...
                >
                  <span
                    className={slMode === "trailing" ? "" : "text-red-400/80"}
                  >
                    {slMode === "trailing"
            ...
            {tpEnabled && tpVal > 0 && (
              <div className="flex justify-between text-emerald-400/80">
                ...
                <span className="tabular-nums">{formatCurrency(tpVal)}</span>
              </div>
            )}
          ...
          <Button
            ...
            disabled={isPending || (!isLoggedIn ? false : qty <= 0)}
